      ...
      case "USDT":
        return (
          <div id="CryptoCurrency">
            <div className="flex flex-row gap-6 w-full rounded-xl p-6 items-center border">
              {/* QR Code */}
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-white/80 text-sm truncate max-w-[140px]">
                        0xhbbCDhd...jh200cD
                      </span>
                      <IconCopy
                        stroke={2}
              ...
              <div className="flex flex-col gap-3 w-full">
                <div className="flex items-center gap-2 w-full justify-start bg-secondary hover:bg-secondary/80 text-white px-4 py-2 rounded-lg cursor-pointer">
                  <Image src={TronLinkIcon} alt="TronLink" width={38} height={41} />
