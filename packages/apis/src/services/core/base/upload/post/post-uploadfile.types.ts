...
// Response
export type PostUploadfileRequest = z.input<typeof postUploadfileSchema.request>;
...
// Request
export type PostUploadfileResponse = z.input<typeof postUploadfileSchema.response>;
