...
// Response
export type PostFileUploadRequest = z.input<typeof postFileUploadSchema.request>;
...
// Request
export type PostFileUploadResponse = z.input<typeof postFileUploadSchema.response>;
